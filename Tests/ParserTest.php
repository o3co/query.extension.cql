...
class ParserTest extends \PHPUnit_Framework_TestCase 
{
    public function testParseFqlComparison()
    {
        ...
        // test comparison match 
        $expr = $parser->parseFql('field', '%:*value*');
        $this->assertInstanceof('O3Co\Query\Query\Part\TextComparisonExpression', $expr);
        $this->assertEquals('field', $expr->getField()->getName());
        $this->assertEquals('*value*', $expr->getValue()->getValue());
        ...
        $this->assertInstanceof('O3Co\Query\Query\Part\RangeExpression', $expr);
        ...
        $this->assertInstanceof('O3Co\Query\Query\Part\CollectionComparisonExpression', $expr);
    ...
    public function testParse()
    {
        ...
        $this->assertInstanceof('O3Co\Query\Query\Part\LogicalExpression', $exprs[0]);
